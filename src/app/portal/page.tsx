...
export default async function PortalDashboardPage() {
  ...
  return (
    <div>
      ...
      <h1 className="mt-2 text-2xl font-semibold tracking-tight text-[#234467] sm:text-3xl">Dashboard</h1>
      ...
      <div className="mt-8 grid gap-6 sm:grid-cols-2">
        <Card className="rounded-2xl border-[#d6deea] bg-white p-5 sm:p-6">
        ...
        <Card className="rounded-2xl border-[#dce9c9] bg-[#f7fbe9] p-5 sm:p-6">
          <p className="text-sm font-medium text-[#8c8d91]">Quick action</p>
          <Link
            href="/portal/products"
            className="mt-4 inline-flex w-full items-center justify-center rounded-full bg-[#00a4e4] px-4 py-2.5 text-sm font-semibold text-white hover:bg-[#0090c8] sm:w-auto"
          >
            Browse catalogue
          </Link>
        </Card>
